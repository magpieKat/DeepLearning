...
class DenseNet(nn.Module):
    ...
    """
    def __init__(self, growth_rate=3, block_config=(16,16,16), compression=0.48,
                 num_init_features=24, bn_size=3, drop_rate=0.2,
...
def plot_graph(vec1, title1, vec2, title2, st, date):
    ...
    plt.xticks(np.arange(1, num_epochs, step=40))
...
if __name__ == '__main__':
    ...
    scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[150, 250, 400],gamma=0.1)
